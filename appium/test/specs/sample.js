...
async function runTest() {
  ...
  console.log("here is the emain and password : " + user.email + " " + user.password);
  console.log("here is the phone number : " + createPhoneNumber())
  try {
    ...
    await loginformId.setValue(user.email);
    ...
    await loginformPassword.setValue(user.password);
    await waitAndClick(
